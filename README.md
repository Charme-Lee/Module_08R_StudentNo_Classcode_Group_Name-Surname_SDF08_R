...
This exercise was a bit easier following the previous content we had to consume. Reflection on the prblem statement, I managed to add the required fields and elements mainly focused on grid layout for multi-dimensional matrix system and Tailwind CSS which was the main objective for this exercise. Tailwind makes it easy to dress HTML content over vanilla CSS which can become complex with more lines of code.

My main pain point we grid and finding the correct Tailwind properties, these took me much time. To the exercise I added a shape divider, I thought it would bring an interesting flavour to the plain footer design. In addition to this, there is a div housing Information about the web page and a copy right label at the bottom for completeness.A key takeway for me would be a need to continue improving my understanding of both grid and Tailwind CSS and develop confidence in these areas.
